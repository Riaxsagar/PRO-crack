...
__author__ = 'Riazkhan'
__copyright = 'All rights reserved . Copyright  riazkhan'
...
def ms():
    ...
    if s == '1':
        ...
        print ''
        ms()
#s.system('xdg-open https://www.facebook.com/Riaz-hacker-100835532473815/')
...
def menu_s():
    ...
    if ms == '1':
        ...
        os.system('python2 PRO-crack.py')
    elif ms == '5':
        lout()
    elif ms == '6':
        rtrash()
